label lilyintro:
    ...
    if metLily == False:
        ...
        "You knocked on the door of the guidance office only to be met with silence...."
        
        "After a few seconds have passed you knock again"

        "but this time you tried peeking into the small window of the guidance office to see if there is anyone inside."

        "Just as you were about to leave a face of girl peeked into the same window you were peeking at jumpscaring you a bit"
